...
#-------------X vs Y direction semivariograms
myData_x <- semivarES(x,y,v,50,180)
myData_y <- semivarES(x,y,v,30,90)

plot(myData_x$Distance,myData_x$Semivariance,xlab="Distance(mm)",ylab="Variance(mD)",ylim=c(0,9000),xlim = c(0,300),col = "red")
par(new=TRUE)
plot(myData_y$Distance,myData_y$Semivariance,xlab="Distance(mm)",ylab="Variance(mD)",ylim=c(0,9000),xlim = c(0,300),col = "blue")
legend(200, 8000, legend=c("Theta = 0", "Theta= 90"),
