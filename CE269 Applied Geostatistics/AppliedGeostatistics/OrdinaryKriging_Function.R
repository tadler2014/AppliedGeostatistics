...
myData <- data.frame("x"=c(61,63,64,68,71,73,75),"y"=c(139,140,129,128,140,141,128),"v1"=c(477,696,227,646,606,791,783))
myModel <- function(h){10*exp(-0.3*h)}
grid <- data.frame("x"=65,"y"=137)
